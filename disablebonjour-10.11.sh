...
then
	...
	if [[  $(sw_vers -productVersion | grep '10.[6-9]') ]] || [[  $(sw_vers -productVersion | grep '10[.10-11][.0-9]') ]]
	then
		...
		then
			...
			echo "MULTICAST DISABLED (OS X 10.6-10.9 or 10.10.4+ or 10.11+), PLEASE REBOOT"
		fi
		exit
	else
